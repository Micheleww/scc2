...
# 如果传入了命令且不是默认的 gateway 命令，执行传入的命令
if [ $# -gt 0 ] && [ "$*" != "node L1_code_layer/gateway/gateway.mjs" ]; then
...
echo "  4. Job Executor Bridge"
echo "  5. Role Router"
echo ""
echo "Service Chain:"
echo "  Parent Inbox → Jobs Store → Job Executor Bridge → Role Router → OLT CLI"
echo ""
echo "=================================="
echo ""
