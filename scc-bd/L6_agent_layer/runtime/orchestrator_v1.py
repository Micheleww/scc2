...
def _factory_policy() -> Dict[str, Any]:
    """Load factory policy from config file.

    Returns:
        Factory policy dict, or empty dict if file doesn't exist or is invalid.
    """
    ...
    try:
        ...
        # File doesn't exist, is not valid JSON, or cannot be read
        return {}
