...
from L13_security_layer.gatekeeper.ata_hashchain import validate_ata_hashchain
...
def test_ata_hashchain_broken():
    ...
    # 计算 sha256
    from L13_security_layer.gatekeeper.ata_hashchain import calculate_sha256
