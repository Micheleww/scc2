...
## 功能名称
OLT CLI - OpenCode CLI 到 OpenAI API 的桥接服务器
...
```bash
# Bridge V1 (自动工具执行)
node L6_execution_layer/olt_cli_bridge.mjs
...
- `olt_cli_bridge.mjs` - Bridge V1 实现
- `olt_cli_bridge_v2.mjs` - Bridge V2 实现
- `trae_executor_v2.mjs` - 使用 OLT CLI 的执行器
