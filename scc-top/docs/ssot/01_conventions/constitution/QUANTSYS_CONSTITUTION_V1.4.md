---
oid: 01KGFSKMG2J806B74WRK7NFEJV
layer: DOCOPS
...
工程对应：
- docs/ssot/01_conventions/constitution/QUANTSYS_CONSTITUTION_V1.4.md（本宪法）
...
## 5️⃣ V1.3 → V1.4 变更摘要
1. 新增风险哲学章节，明确承认三类根本风险
2. 冻结 w 的正式定义，严格限制其作用范围
3. 新增从 w 到 Risk Budget 的完整链路定义
4. 新增仓位计算模块，规定唯一合法的仓位计算公式
5. 明确三维 Market Belief 在仓位中的合法作用
6. 新增防出局制度，包含防连续亏损、防单次爆亏、防模型错误
7. 强化观测性要求，增加仓位计算相关追溯字段
8. 调整模块编号，适应新增模块
9. 明确禁止使用 Kelly、胜率、期望收益直接计算仓位
10. 强调“空仓”是主动决策而非失败状态
...
## 验收提示词
**TaskCode: QUANTSYS_CONSTITUTION_V1_4_UPDATE_001**

**提交**
- 最终回复以 SUBMIT 盖章
- ≤8 行总结：V1.4 冻结了什么、禁止了什么、下一步工程工作是什么
