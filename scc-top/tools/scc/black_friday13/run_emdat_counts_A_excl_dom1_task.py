...
def main() -> int:
    ap = argparse.ArgumentParser(description="Create+run SCC contract task for EM-DAT Variant A sensitivity (exclude dom=1).")
    ap.add_argument("--task-id", default="BLACK_FRIDAY13_EMDAT_COUNTS_A_EXCL_DOM1_V010")
    ap.add_argument(
        "--contract-ref",
        default="docs/ssot/04_contracts/black_friday13/contract_black_friday13_emdat_counts_a_excl_dom1_v010.json",
    )
