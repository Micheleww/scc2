$downloadUrl = 'https://downloads.cursor.com/lab/2026.01.28-fd13201/'
...
function Initialize-CursorAgent {
    ...
    ## Create c:\scc\cursor-agent\versions
    ## Add c:\scc\cursor-agent to PATH
    $agentPath = "c:\scc\cursor-agent"
...
Download-InstallPackage -UrlPrefix $downloadUrl -TargetPath "c:\scc\cursor-agent\versions" -Version $version
